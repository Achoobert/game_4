...
@export_file('*.tres') var boxes_stylebox_normal: String = "res://dialogic/Modules/Layouts/Messenger/Layer_Choices/choice_panel_normal.tres"
@export_file('*.tres') var boxes_stylebox_hovered: String = "res://dialogic/Modules/Layouts/Messenger/Layer_Choices/choice_panel_hover.tres"
@export_file('*.tres') var boxes_stylebox_pressed: String = ""
@export_file('*.tres') var boxes_stylebox_disabled: String = ""
@export_file('*.tres') var boxes_stylebox_focused: String = "res://dialogic/Modules/Layouts/Messenger/Layer_Choices/choice_panel_focus.tres"
